...
<div class="detail-card">
    ...
    <div class="detail-actions">
        ...
        <form method="POST" action="<?php echo url('/admin/users/' . $user['id'] . '/delete'); ?>" onsubmit="return confirm('Are you sure?')"><button type="submit" class="btn-danger">Delete</button></form>
