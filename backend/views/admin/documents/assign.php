...
<div class="form-card">
    ...
    <form method="POST" action="<?php echo url('/admin/documents/assign/store'); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" placeholder="e.g., 10th Marksheet, Passport Copy, Bank Statement">
