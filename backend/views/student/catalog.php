...
<div class="catalog-page">
    <section class="catalog-header">
        ...
        <p>Browse our partner institutions and available courses for your study destination.</p>
    </section>

    <section class="catalog-filters">
        <form method="GET" action="<?php echo url('/student/catalog'); ?>" style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;">
